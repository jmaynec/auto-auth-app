...
import cl.mayne.muvo.SimpleGrantedAuthoritiesMixin;
import cl.mayne.muvo.auth.filter.KeySecretConstant;
...
public class JWTServiceImpl implements JWTService {
	...
	public String create(Authentication auth) throws IOException {
		...
		String token = Jwts.builder()
	            .setClaims(claims)
	            .setSubject(username)
	            .signWith(KeySecretConstant.SECRET_KEY)
	...
	public Claims getClaims(String token) {
		Claims claims = Jwts.parser()
                .setSigningKey(KeySecretConstant.SECRET_KEY)
